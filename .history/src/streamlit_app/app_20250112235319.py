...
if not st.session_state["simulation_ran"]:
    st.write("""
        ...
        "Simulate the evolution of troglobite traits in cave environments by testing out different cave conditions and fish populations.", simulating how traits like pigmentation, eye size, and metabolic rate adapt over time. The simulation explores key challenges of cave life, including limited food, perpetual darkness, and isolation.
