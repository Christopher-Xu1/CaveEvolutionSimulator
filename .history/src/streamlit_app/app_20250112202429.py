...
if st.sidebar.button("Run Simulation"):
    ...
    if results:
        ...
        st.line_chart(results["population_sizes"])
                # Dynamically create checkboxes for each trait in the results
        ...
        # Filter traits based on toggles (guard against missing keys)
        selected_traits = {trait: values for trait, values in results["trait_averages"].items() if trait_toggles.get(trait, False)}
