...
class Organism:
    def __init__(self, genetics=None):
        if genetics is not None:
            ...
            self.genetics = {
                ...
                'metabolic_rate': genetics['pigmentation']+genetics['eye_size']+
    ...
    def calculate_fitness(self, environment_patch):
        ...
        W_r = (
            patch['optimal_traits']['metabolic_rate'] * (1 - self.genetics['pigmentation']) + 
            patch['optimal_traits']['metabolic_rate'] * (1 - self.genetics['eye_size'])
        )
