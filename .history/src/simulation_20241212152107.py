...
def run_simulation(num_decades, initial_population_size, preset_name, num_patches=1, fitness_threshold=0.2, egg_count=3000):
    mutation_rate = 5.97e-9  # Default mutation rate from literature
    ...
    for generation in range(1, num_generations + 1):
        ...
        for organism in population:
            if organism.fitness >= fitness_threshold:
                ...
                survival_rate = 1 / (egg_count / 50)  # Trade-off between egg count and survival rate
                surviving_offspring = int(egg_count * survival_rate)
...
if __name__ == "__main__":
    ...
    run_simulation(num_decades, initial_population_size, preset_name, fitness_threshold=fitness_threshold, egg_count=egg_count)
