...
def run_simulation(
    ...
    for generation in range(1, num_generations + 1):
        ...
        for organism in viable_population:
            ...
            repoductive_capability= max((organism.fitness * 2) * ((egg_count)*(1+food_availability)** 3 / egg_count)
            count = random.int(repoductive_capability-1, repoductive_capability+1)
