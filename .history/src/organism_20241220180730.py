...
class Organism:
    def __init__(self, genetics=None):
        if genetics is not None:
            ...
            self.genetics['metabolic_rate']= (self.genetics['pigmentation']+self.genetics['eye_size'] + self.genetics['lateral_line'] + self.genetics['olfactory_bulb'])/4
    ...
    def calculate_fitness(self, environment_patch):
        ...
        C = 0.2 * self.genetics['metabolic_rate']
