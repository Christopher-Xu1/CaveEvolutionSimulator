    ...
    def __init__(self, genetics=None):
        if genetics is not None:
            ...
            self.genetics = {
                ...
                'eye_size': random.gauss(0.5, 0.181),      # Regressive trait
                'metabolic_rate': random.uniform(0.5, 0.181),  # Adaptive trait
                'lateral_line': random.uniform(0.5, 0.181),  # Adaptive trait
                'olfactory_bulb': random.uniform(0.5, 0.181) # Adaptive trait
            }
        self.fitness = 0
