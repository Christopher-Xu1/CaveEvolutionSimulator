...
class Organism:
    ...
    def __init__(self, genetics=None):
        ...
        if genetics is not None:
            ...
            self.genetics = {
                int(input("pigmentation:")),     # 0 = no pigmentation, 1 = full pigmentation
    ...
    def mutate(self, mutation_rate):
        ...
        for trait in self.genetics:
            if random.random() < mutation_rate:
                ...
                mutation_amount = random.gauss(0, 0.05)  # Mean 0, standard deviation 0.1
...
# Example usage of the Organism class

# Create two parent organisms
parent1 = Organism()
parent2 = Organism()

# Simulate reproduction to create an offspring
offspring = Organism.reproduce(parent1, parent2)

# Define an example environment with optimal traits
class Environment:
    optimal_traits = {
        'pigmentation': 0.0,     # Prefer no pigmentation in dark caves
        'eye_size': 0.0,         # Reduced eyes are advantageous
        'antennae_length': 1.0,  # Longer antennae are beneficial
        'metabolic_rate': 0.3,   # Lower metabolic rates are preferred
    }
...
# Print the organism's genetics and fitness
print(offspring)
