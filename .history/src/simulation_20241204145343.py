...
def run_simulation(num_generations, initial_population_size, mutation_rate):
    ...
    :param initial_population_size: Number of organisms in the initial population.
    :param mutation_rate: Probability of mutation for each trait during reproduction.
    """
