...
def run_simulation(
    ...
    for generation in range(1, num_generations + 1):
        ...
        initial_fitness = [org.fitness for org in population]
        avg_initial_fitness = np.mean(initial_fitness) if initial_fitness else 0
        print(f"Initial Average Fitness: {avg_initial_fitness:.4f}")
        ...
        fitness_values = [org.calculate_fitness for org in population]
        avg_fit = np.mean(fitness_values) if fitness_values else 0
