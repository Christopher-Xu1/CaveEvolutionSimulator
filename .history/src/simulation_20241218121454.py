...
# Calculate density-dependent survival rate
survival_rate = max(0, 1 - (len(population) / carrying_capacity))

# Generate offspring based on fitness and survival rate
offspring_population = []
for organism in viable_population:
    num_offspring = int((organism.fitness * egg_count * survival_rate) / len(viable_population))
